...
public class MainActivity extends AppCompatActivity {
    ...
    String[] district = {"GTA 6 release date year confirmed by first trailer","Chittagong","Rangpur","Sylhet","Mymensingh"};

    Integer[] ImageId ={R.drawable.gta6,R.drawable.chittagong,R.drawable.rangpur,R.drawable.sylhet,R.drawable.mymensingh};
